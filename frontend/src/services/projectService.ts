...
import type { Project, ProjectsResponse, ProjectCreateRequest } from '@/types/project';
...
class ProjectService {
  ...
  transformProject(backendProject: any): Project {
    return {
      ...
      location: `Lat: ${backendProject.project_latitude?.toFixed(4)}, Lng: ${backendProject.project_longitude?.toFixed(4)}`,
      ...
      coordinates: backendProject.project_latitude && backendProject.project_longitude ? {
